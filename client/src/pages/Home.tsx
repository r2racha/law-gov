...
const quizGroups = [
  { category: "error", title: "ความจำ · Error Test", subtitle: "จับประโยคที่คลาดเคลื่อนจากตัวบท", tone: "bg-[#FFE9DC] text-[#A45726]" },
  { category: "accuracy", title: "ความจำ · ความแม่นยำทางกฎหมาย", subtitle: "เช็กตัวเลข เวลา และหลักเกณฑ์สำคัญ", tone: "bg-[#E1F1EC] text-[#0E766F]" },
  { category: "analysis", title: "การวิเคราะห์", subtitle: "เลือกหลักกฎหมายที่ใช้กับข้อเท็จจริง", tone: "bg-[#E3EDF8] text-[#285F8D]" },
  { category: "scenario", title: "สถานการณ์จำลอง", subtitle: "ลองตัดสินใจในเหตุการณ์ใกล้เคียงงานราชการ", tone: "bg-[#F0E6F5] text-[#765282]" },
] as const;
